...
// calls silently render nothing. Components still call static `message`, so the patch
// must be imported before any antd usage. It exists only to keep antd v5 alive on
// React 19, so it goes when antd goes.
